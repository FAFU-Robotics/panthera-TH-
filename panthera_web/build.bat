@echo off
REM ============================================================================
REM  build.bat  --  Windows 一键构建 panthera_motor (pybind11) 模块
REM
REM  用法:
REM    build.bat                 # Release 构建 (推荐)
...
REM
REM  产物:
REM    panthera_web\panthera_motor.cpXY-win_amd64.pyd
REM    panthera_web\serial_cmake.dll
REM ============================================================================
...
echo.
echo ================================================================
echo  panthera_motor build (%BUILD_TYPE%)
echo ================================================================
echo.
...
echo.
echo 验证导入:
"%PY_EXE%" -c "import panthera_motor; print('OK', panthera_motor.__file__); print(dir(panthera_motor))"
goto :eof
